-- ============================================================
-- Collection App — Schema final (do zero, limpar tudo antes)
--
-- DROP TABLE IF EXISTS user_items, user_editions, user_series,
--                      editions, series CASCADE;
-- DROP TYPE  IF EXISTS category_enum, ownership_enum,
--                      read_status_enum, item_type_enum CASCADE;
-- ============================================================
...
--   Acesso rápido à série — sem status, só referência e capa para exibição.
...
CREATE TABLE user_series (
    ...
    cover_url    text,                   -- capa do 1º volume (thumbnail da série)
    publisher    text,
    issue_count  text,
...
--   Salvo ao interagir com os chips na DetailsScreen.
